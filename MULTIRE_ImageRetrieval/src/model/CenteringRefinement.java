 ...
 * [x] 3. Split histogram bucket to center and non-center
 ...
 * []  4. Compare the center bucket and the non-center bucket separately using Euclidean distance?
 */
...
//		System.out.println();
	...
	public float getSimilarity(CenteringRefinement img2){
...
//		System.out.println("==== "+histogramBucketCenter.length);
...
//		return finalAns;
	...
	public float getEucDistance(CenteringRefinement img2){
		float eucDistance = 0;
